...
class _FoodPortionListState extends State<FoodPortionList> with SingleTickerProviderStateMixin {
  ...
  final List<Makanan> makananList = [
    Makanan(namaMakanan: 'Nasi Merah dan telur rebus', kaloriMakanan: 100, beratMakanan: 100, kategoriMakanan: KategoriMakanan.makan_siang),
    Makanan(namaMakanan: 'Ayam panggang', kaloriMakanan: 200, beratMakanan: 150, kategoriMakanan: KategoriMakanan.makan_siang),
    Makanan(namaMakanan: 'Sayur Lodeh dan tempe orek', kaloriMakanan: 50, beratMakanan: 200, kategoriMakanan: KategoriMakanan.makan_siang),
    Makanan(namaMakanan: 'Salad quinoa dengan ayam', kaloriMakanan: 150, beratMakanan: 100, kategoriMakanan: KategoriMakanan.makan_siang),
    Makanan(namaMakanan: 'Tahu tempe tumis sayuran', kaloriMakanan: 120, beratMakanan: 150, kategoriMakanan: KategoriMakanan.makan_siang),
  ];
